...
class MuonIdProducer : public edm::stream::EDProducer<> {
 ...
 private:
   ...
   int sharedHits(const reco::Track& track1, const reco::Track& track2) const; ////added	
  
   float frac_sharedHitsPixel(const reco::Track& track1, const reco::Track& track2) const; ////added

   int sharedHits_frac_sharedHitsPixel(const reco::Track& track1, const reco::Track& track2) const; ////added   

   //edm::EDGetTokenT<std::vector<reco::TrackCollection>> tracksToken_; ////added

   //edm::EDGetTokenT<reco::MuonTrackLinksCollection> linksToken_; ////added
